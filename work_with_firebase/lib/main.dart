...
import 'package:work_with_firebase/cubits/current_user_info_cubit.dart';
...
void main() async {
  ...
  try {
    await FirebaseAuth.instance.createUserWithEmailAndPassword(
        email: "isip_i.a.gorev@mpt.ru", password: "123!As456");
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    emailController.text = "isip_i.a.gorev@mpt.ru";
    passwordController.text = "123!As456";
